# Initialize Supabase database using SQL script (Part 1)
# 
# Author: QuantDB Team
# Date: 2025-05-19
...
# Get SQL script path
$sqlScriptPath = Join-Path $PSScriptRoot "..\database\supabase_schema_part1.sql"

# Display connection info
Write-Host "Initializing Supabase PostgreSQL database (Part 1)..."
...
Write-Host "Database initialization (Part 1) completed."

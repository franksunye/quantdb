...
1. 🔴 **清理代码** - 修复测试，清理过时文件
2. 🟡 **整理更新文档** - 简化，保持最新
3. 🟡 **SQLite版本稳定化** - 确保所有功能在开发环境中正常工作
4. 🔵 **MCP协议** - 未来再考虑
5. 🔵 **Supabase部署** - 未来再考虑
...
- [ ] 修复历史数据API测试
  ...
  - [ ] 修复mock对象配置
- [ ] 清理过时测试文件
  - [ ] 删除 `tests/unit/test_cache_engine.py`
  - [ ] 删除 `tests/unit/test_freshness_tracker.py`
  - [ ] 重构 `tests/unit/test_akshare_adapter_simplified.py`
- [ ] 验证所有核心功能测试100%通过

...
from qdb.client import LightweightQDBClient, get_lightweight_client, reset_lightweight_client, _get_service_manager
...
class TestLightweightQDBClientCoverage(unittest.TestCase):
    ...
    def test_get_service_manager_lazy_init_without_cache_dir(self, mock_get_service_manager):
    ...
    @patch('qdb.client._get_service_manager')
    def test_get_service_manager_lazy_init_with_cache_dir(self, mock_get_service_manager, mock_reset, mock_core_get):
    ...
    def test_get_stock_data_with_days(self, mock_get_service_manager):
        ...
        mock_stock_service.get_stock_data_by_days.assert_called_once_with("000001", 30, "")
    ...
    def test_get_stock_data_with_date_range(self, mock_get_service_manager):
        ...
        client = LightweightQDBClient()
        result = client.get_stock_data("000001", start_date="20240101", end_date="20240201")
        
        mock_stock_service.get_stock_data.assert_called_once_with("000001", "20240101", "20240201", "")
        self.assertEqual(result, {"test": "data"})
    ...
    def test_get_multiple_stocks(self, mock_get_service_manager):
        ...
        mock_service_manager = Mock()
        mock_stock_service = Mock()
        mock_stock_service.get_multiple_stocks.return_value = {"000001": {"test": "data"}}
        mock_service_manager.get_stock_data_service.return_value = mock_stock_service
        mock_get_service_manager.return_value = mock_service_manager
        ...
        mock_stock_service.get_multiple_stocks.assert_called_once_with(["000001", "000002"], 30, adjust="qfq")
    ...
    def test_get_realtime_data(self, mock_get_service_manager):
        ...
        mock_service_manager.get_realtime_data_service.return_value = mock_realtime_service
        mock_get_service_manager.return_value = mock_service_manager
    ...
    def test_get_realtime_data_batch(self, mock_get_service_manager):
        ...
        mock_service_manager = Mock()
        mock_realtime_service = Mock()
        mock_realtime_service.get_realtime_data_batch.return_value = {"000001": {"current_price": 10.5}}
        mock_service_manager.get_realtime_data_service.return_value = mock_realtime_service
        mock_get_service_manager.return_value = mock_service_manager
        ...
        mock_realtime_service.get_realtime_data_batch.assert_called_once_with(["000001", "000002"])
    ...
    def test_get_stock_list(self, mock_get_service_manager):
        ...
        mock_service_manager = Mock()
        mock_stock_service = Mock()
        mock_stock_service.get_stock_list.return_value = [{"symbol": "000001", "name": "Test"}]
        mock_service_manager.get_stock_data_service.return_value = mock_stock_service
        mock_get_service_manager.return_value = mock_service_manager
    ...
    def test_stock_zh_a_hist(self, mock_get_service_manager):
        ...
        client = LightweightQDBClient()
        result = client.stock_zh_a_hist("000001", "daily", "20240101", "20240201", "qfq")
        
        mock_stock_service.stock_zh_a_hist.assert_called_once_with("000001", "daily", "20240101", "20240201", "qfq")

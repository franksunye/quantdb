# Query Supabase PostgreSQL database with SSL certificate PowerShell script
...
# Display query info
Write-Host "Querying Supabase PostgreSQL database with SSL..."
...
# Execute query
& psql $connectionString -c $SqlQuery

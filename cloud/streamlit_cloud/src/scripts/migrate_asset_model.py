            ...
            for column in missing_columns:
                try:
                    if column == 'industry':
                        ...
                        conn.execute(text("ALTER TABLE assets ADD COLUMN circulating_shares BIGINT"))
                        ...
                        conn.execute(text("ALTER TABLE assets ADD COLUMN data_source VARCHAR DEFAULT 'akshare'"))
...
def verify_migration():
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            expected_columns = [
                'asset_id', 'symbol', 'name', 'isin', 'asset_type', 'exchange', 'currency',
                'industry', 'concept', 'listing_date', 'total_shares', 'circulating_shares',
                'market_cap', 'pe_ratio', 'pb_ratio', 'roe', 'last_updated', 'data_source'
            ]

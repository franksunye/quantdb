...
class ServiceManager:
    ...
    def __init__(self, cache_dir: Optional[str] = None, database_url: Optional[str] = None):
        """
...
def get_service_manager(cache_dir: Optional[str] = None, 
                       database_url: Optional[str] = None) -> ServiceManager:
    """
